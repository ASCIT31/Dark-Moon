...
![DarkMoon Logo](assets/logo_white.png)

**AI-Powered Autonomous Penetration Testing Platform**

[![License: GPL v3](https://img.shields.io/badge/License-GPLv3-blue.svg)](https://www.gnu.org/licenses/gpl-3.0)
[![GitHub stars](https://img.shields.io/github/stars/yourusername/darkmoon.svg?style=social&label=Star)](https://github.com/yourusername/darkmoon)
...
```bash
git clone https://github.com/asc-it/darkmoon.git
cd darkmoon
```
...
![Video](assets/darkmoon_demo_fast.mp4)
...
[⭐ Star us on GitHub](https://github.com/asc-it/darkmoon) • [📖 Full Documentation](docs/full.md)
